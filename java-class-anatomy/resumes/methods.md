...
20;Caso o método não retorne nenhum valor, ele será representado pela palavra-chave `void`.&#x20;
...
TEXTO: [DIO](https://github.com/digitalinnovationone/trilha-java-basico/blob/main/gitbook/sintaxe/metodos.md)